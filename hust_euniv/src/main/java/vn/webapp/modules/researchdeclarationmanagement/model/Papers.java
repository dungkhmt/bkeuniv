...
public class Papers implements Serializable{
    ...
    public PaperCategory paperCategory;

	@ManyToOne
	@JoinColumn(name="PDECL_User_Code", referencedColumnName = "Staff_Code", insertable=false, updatable=false)
	public Staff staff;
	
	@ManyToMany(cascade=CascadeType.ALL, fetch = FetchType.LAZY, targetEntity = Staff.class)  
    @JoinTable(name="tblpaperstaffs", 
    		   joinColumns=@JoinColumn(name="PPSTF_PaperCode", referencedColumnName = "PDECL_Code"), 
    		   inverseJoinColumns=@JoinColumn(name="PPSTF_StaffCode", referencedColumnName = "Staff_Code")) 
	private Set<Staff> authors = new HashSet<Staff>();
	...
	public String getPDECL_Month() {
		return PDECL_Month;
	}

	public void setPDECL_Month(String pDECL_Month) {
		PDECL_Month = pDECL_Month;
	}

	public Set<Staff> getAuthors() {
		return authors;
	}

	public void setAuthors(Set<Staff> authors) {
