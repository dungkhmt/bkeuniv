...
public class PaperCategory implements Serializable{
    ...
    private Set<PapersCategoryHourBudget> papersCategoryHourBudget;
	...
	public Set<PapersCategoryHourBudget> getPapersCategoryHourBudget() {
		return papersCategoryHourBudget;
	}

	public void setPapersCategoryHourBudget(
			Set<PapersCategoryHourBudget> papersCategoryHourBudget) {
