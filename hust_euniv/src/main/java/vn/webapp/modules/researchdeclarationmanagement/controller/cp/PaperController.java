...
import vn.webapp.modules.researchdeclarationmanagement.service.AcademicYearService;
import vn.webapp.modules.researchdeclarationmanagement.service.PaperCategoryHourBudgetService;
import vn.webapp.modules.researchdeclarationmanagement.service.PaperCategoryService;
import vn.webapp.modules.researchdeclarationmanagement.service.PaperService;
import vn.webapp.modules.usermanagement.model.User;
import vn.webapp.modules.usermanagement.service.UserService;

@Controller("cpmPaper")
@RequestMapping(value = {"/researchdeclaration"})
...
//    private DepartmentService departmentService;
    ...
    @Autowired
    private PaperCategoryHourBudgetService paperCategoryHourBudgetService;
    
    @Autowired
    private UserService userService;
    
    static final String status = "active";
    static final Logger logger = Logger.getLogger(PaperController.class);
   ...
   public String paperList(ModelMap model, HttpSession session) {
	   logger.info("::paperList, requestMapping /papers");
...
//	   String userRole = session.getAttribute("currentUserRole").toString();
	   ...
	   logger.info("::paperList, userCode = " + user.getUser_Code());
	     
	   List<Papers> papersList = paperService.loadPaperListByAuthor(user.getUser_Code());
	   model.put("papersList", papersList);
	   model.put("papers", status);
	   logger.info("::paperList, userCode = " + user.getUser_Code() + "OK");
	   return "rd.papers.list";
   }
...
//	   
//	   // Get list reportingYear
//	   List<mAcademicYear> patentReportingAcademicDateList = academicYearService.list();//glb_academicYear;
//	   String paperConvertedHours = this.setJsonByListPaperCategory(papersCategoryHourBudget, patentReportingAcademicDateList);
//	   List<mFaculty> listFaculty = facultyService.loadFacultyList();//glb_faculties;
//	   List<mStaff> staffList = staffService.listStaffs();//glb_staffs;
//	   
//	   //Put data back to view
//	   model.put("patentReportingAcademicDateList", patentReportingAcademicDateList);
//	   model.put("paperConvertedHours", paperConvertedHours);
...
//		   List<mPaperCategory> paperCategory = paperCategoryService.list();//glb_paperCategories;
//		   List<mJournal> journalList = journalService.list();//glb_journalList;
//		   List<mPapersCategoryHourBudget> papersCategoryHourBudget = paperCategoryHourBudgetService.loadPaperCategoryHourBudgets();//glb_papersCategoryHourBudget;//
//		   String paperConvertedHours = this.setJsonByListPaperCategory(papersCategoryHourBudget, patentReportingAcademicDateList);
...
//   	   String userCode = session.getAttribute("currentUserCode").toString();
//	   
//   	   List<mPaperCategory> paperCategories = paperCategoryService.list();//glb_paperCategories;//
//	   List<mJournal> journalList = journalService.list();//glb_journalList;//
//	   List<mPapersCategoryHourBudget> papersCategoryHourBudget = paperCategoryHourBudgetService.loadPaperCategoryHourBudgets();//glb_papersCategoryHourBudget;//
//	   
//	   // Get list reportingYear
...
//			threadFaculties = facultyService.loadFacultyList();//glb_faculties;//
...
//		List<mPaperCategory> paperCategory = paperCategoryService.list();//glb_paperCategories;//
//		// Get list reportingYear
//		List<mAcademicYear> paperReportingAcademicYearList = academicYearService.list();//glb_academicYear;//
//		
//		// Put data back to view
